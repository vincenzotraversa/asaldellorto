...
import frame from "../assets/countdown-frame.png";
...
export default function Countdown({ targetIso = "2026-07-31T00:00:00" }) {
  ...
  return (
    <div className="countFrame" aria-label="Countdown">
      <img className="countFrameImg" src={frame} alt="" aria-hidden="true" />

      <div className="countFrameOverlay">
